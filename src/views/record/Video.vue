    ...
    >
        ...
        <transition-group name="fade" mode="out-in">
            ...
            <div v-else key="record-view">
                ...
                <!-- BUTTONS -->
                <div class="flex">
                    <button class="transition-all mx-auto mt-8 mb-4 w-20 h-20 flex items-center justify-center
                ...
                <div class="flex flex-wrap">
                    <div class="image-wrapper w-1/2 p-1" v-for="(image, i) in images" :key="i">
                        <span class="relative list-image transform origin-center z-0"
                            :class="{
                        ...
                        >
                            ...
                            >
                            <span class="flex bg-gray-400 -mt-4 pt-4">
        ...
        const startStalking = (time) => {
            intervalId = setTimeout(async () => {
                ...
                const toastMsg = predictionsClasses.length 
                    ...
                    : 'Nothing detected'
                toast(toastMsg, {
                    timeout: 1500, // isThereADog ? appState.stalkingInterval : appState.checkInterval,
                    draggable: true,
